set dirname=C:\_suzuki\work_suzuki\research\aaa\2_gdaa\work\result_and_mesh\
...
%dirname%seg_spline\header.txt ^
%dirname%seg_spline\output\centerline_sigma0\centerline_d5_cp121_lmd1d0.000_lmd2d0.000_lmd3d10.000_lmd4d0.000_spline3d.txt ^
%dirname%SPSURFACE_ori\ 5 5 115 0.25 31 15 0
