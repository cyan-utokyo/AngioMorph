...
%dirname%geometry_info\output\centerline_sigma0\centerline_d5_cp121_lmd1d0.000_lmd2d0.000_lmd3d1.000_lmd4d0.000_spline3d.txt ^
%dirname%geometry_info\SPSURFACE\ 5 5 110 0.25 31 15 0
