...
set dirname=P:\U\AAA\_work\20151008\
...
start "elliptical_helix_a1_b2_c10" batchVModeler.exe 1019 %dirname%elliptical_helix_201_a1_b2_c10_sgm001.txt %dirname%param_elliptical_helix.txt 1 10 2
